...
import { Card, Table, Statistic, Row, Col, Space, Tag, Typography, Tabs, Empty, Spin, Timeline, message } from 'antd'
import { ShoppingCartOutlined, AppstoreOutlined, UserOutlined, DollarOutlined, CalendarOutlined } from '@ant-design/icons'
                          ...
                          <div style={{ paddingLeft: 40 }}>
                            ...
                            <div style={{ marginTop: 8 }}>
                              {variant.orders.map((order) => (
                                <div key={order.sale_id} style={{ marginBottom: 8, paddingLeft: 8, borderLeft: '2px solid #d9d9d9' }}>
                                  <Space size="middle">
