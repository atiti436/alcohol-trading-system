🔴 TypeScript 錯誤 - Button 組件屬性問題
錯誤位置： src/app/products/page.tsx 第 879 行

錯誤訊息：



Property 'tooltip' does not exist on type 'IntrinsicAttributes & ButtonProps & RefAttributes<HTMLAnchorElement | HTMLButtonElement>'.
問題代碼：
...
/>
💡 問題分析
Ant Design 的 Button 組件沒有 tooltip 屬性。在 Ant Design 中，要顯示提示信息需要使用 Tooltip 組件包裹。
...
修復這個 TypeScript 錯誤後，應該就能成功建置了！這是一個常見的 Ant Design 組件使用錯誤。
